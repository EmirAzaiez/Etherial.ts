...
export function validateFlow(triggerId, graph) {
    var _a, _b, _c, _d, _e;
    const issues = [];
    const nodes = (_a = graph === null || graph === void 0 ? void 0 : graph.nodes) !== null && _a !== void 0 ? _a : [];
    const edges = (_b = graph === null || graph === void 0 ? void 0 : graph.edges) !== null && _b !== void 0 ? _b : [];
    ...
    for (const node of nodes) {
        ...
        for (const field of resolveConfigSpec(definition.config, (_c = node.config) !== null && _c !== void 0 ? _c : {})) {
            if (!field.required)
                continue;
            const value = (_d = node.config) === null || _d === void 0 ? void 0 : _d[field.name];
        ...
        const branches = (_e = definition.branches) !== null && _e !== void 0 ? _e : [];
