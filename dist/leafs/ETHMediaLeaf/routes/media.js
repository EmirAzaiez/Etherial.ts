...
let ETHMediaLeafMediaController = class ETHMediaLeafMediaController {
    /**
     * Request Upload URL
     *
    ...
    requestUpload(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (rule) {
                    // Check quota first
                    const quotaCheck = yield etherial.eth_media_leaf.canUpload(req.user.id, req.form.file_size);
                    ...
                    if (!rule.max_size || req.form.file_size <= rule.max_size) {
                        if (!rule.mime_types || rule.mime_types.includes(req.form.content_type)) {
                            ...
                            const url = yield getSignedUrl(etherial.eth_media_leaf.s3, command, { expiresIn: 60 * 15 });
                            let media = yield Media.create({
                                key: key,
    ...
    confirmUpload(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const media = yield Media.findOne({
                    where: {
                        id: mediaId,
                        uploaded_by: req.user.id,
                    },
                ...
                const exists = yield etherial.eth_media_leaf.fileExists(media.key);
                if (!exists) {
                    return res.error({
                        status: 400,
                ...
                // Add to quota
                yield etherial.eth_media_leaf.addToQuota(req.user.id, media.file_size);
    ...
    getMedia(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Check access
                const hasAccess = yield etherial.eth_media_leaf.checkAccess(req, media);
                if (!hasAccess) {
                    return res.error({
                        status: 403,
                ...
                if (media.visibility === 'public-read') {
                    ...
                    url = yield etherial.eth_media_leaf.generateSignedUrl(media);
                }
                res.success({
                    status: 200,
                    data: {
    ...
    getMediaAccess(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const expiresIn = req.query.expires_in ? parseInt(req.query.expires_in, 10) : undefined;
                const url = yield etherial.eth_media_leaf.generateSignedUrl(media, expiresIn);
                const rule = etherial.eth_media_leaf.getRuleForFolder(media.folder);
                const actualExpiration = (_a = expiresIn !== null && expiresIn !== void 0 ? expiresIn : rule === null || rule === void 0 ? void 0 : rule.signedUrlExpiration) !== null && _a !== void 0 ? _a : 3600;
                res.success({
                    status: 200,
                    data: {
                        url: url,
    ...
    deleteMedia(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Delete from S3
                const deleted = yield etherial.eth_media_leaf.deleteFile(media.key);
                if (!deleted) {
                    console.warn(`Failed to delete file from S3: ${media.key}, but continuing with DB deletion`);
                }
                // Remove from quota
                yield etherial.eth_media_leaf.removeFromQuota(req.user.id, media.file_size);
    ...
    confirmBulk(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const medias = yield Media.findAll({
                    where: {
                        id: ids,
                        uploaded_by: req.user.id,
                        status: MediaStatus.PENDING,
                ...
                for (const media of medias) {
                    try {
                        const exists = yield etherial.eth_media_leaf.fileExists(media.key);
                        if (exists) {
                            yield media.update({ status: MediaStatus.UPLOADED });
                            // Add to quota
                            yield etherial.eth_media_leaf.addToQuota(req.user.id, media.file_size);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                for (const media of medias) {
                    try {
                        // Delete from S3
                        yield etherial.eth_media_leaf.deleteFile(media.key);
                        // Remove from quota
                        yield etherial.eth_media_leaf.removeFromQuota(req.user.id, media.file_size);
                        // Delete from database
                        yield media.destroy();
    ...
    getUserQuota(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const quota = yield etherial.eth_media_leaf.getOrCreateQuota(req.user.id);
                ...
                res.success({
                    ...
                    data: {
                        ...
                        storage_limit: (_a = quota.custom_quota) !== null && _a !== void 0 ? _a : globalQuota,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (req.query.fit && ['cover', 'contain', 'fill', 'inside', 'outside'].includes(req.query.fit)) {
                    params.fit = req.query.fit;
                }
                if (req.query.format && config.allowedFormats.includes(req.query.format)) {
                ...
                // Transform the image
                const result = yield etherial.eth_media_leaf.transformImage(media, params);
                res.success({
                    status: 200,
                    data: {
                        url: result.url,
...
], ETHMediaLeafMediaController.prototype, "requestUpload", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "confirmUpload", null);
__decorate([
    Get('/medias/:id(\\d+)'),
    ShouldBeAuthenticated(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "getMedia", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "getMediaAccess", null);
__decorate([
    Delete('/medias/:id'),
    ShouldBeAuthenticated(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "deleteMedia", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "confirmBulk", null);
__decorate([
    Delete('/medias/bulk'),
    ShouldBeAuthenticated(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "deleteBulk", null);
__decorate([
    Get('/medias/quota'),
    ShouldBeAuthenticated(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "getUserQuota", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ETHMediaLeafMediaController.prototype, "getMediaTransform", null);
ETHMediaLeafMediaController = __decorate([
    Controller()
], ETHMediaLeafMediaController);
export default ETHMediaLeafMediaController;
