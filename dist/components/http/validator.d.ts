...
export declare const ShouldBeS3File: (s3: any, folder: string) => PropertyDecorator;
...
export declare const ShouldValidateForm: (form: any, { exclude_validator, include_optionals }: {
 ...
 */
export declare const UseForm: (form: any, { exclude_validator, include_optionals }: {
    exclude_validator?: boolean;
    include_optionals?: boolean;
}) => (target: any, propertyKey: string) => void;
