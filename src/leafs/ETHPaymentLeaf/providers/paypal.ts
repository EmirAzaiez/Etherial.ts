...
export class PayPalProvider implements PaymentProvider {
    ...
    private static readonly UNSUPPORTED_FEATURES: PaymentProviderFeature[] = [
    ...
    private async request<T>(method: string, path: string, body?: any, options?: { idempotency_key?: string }): Promise<T> {
